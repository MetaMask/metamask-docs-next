...
<Tip title="Recommended Reading">
  We recommend that all web3 site developers read the [Basic
  Usage](#basic-usage) section.
</Tip>

<Tip title="Recent Breaking Provider Changes">
  If you are an Ethereum application developer and are looking for information
  about our January 2021 provider API changes, please see our [Migration
  Guide](./provider-migration.html) for more details.
</Tip>
